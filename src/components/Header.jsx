...
import { MenuIcon, SearchIcon, UserCircle } from 'lucide-react'
import {PiUserCircleLight} from 'react-icons/pi'
import { LoginPage } from '../Importer'
...
function Header() {
  ...
  return (
    <>
      ...
      <LoginPage display={isLoginVisible} hidden={handleLoginVisiblity}/>
      <div className="grid grid-cols-2 md:grid-cols-3 justify-between items-center w-full h-[50px] md:h-[80px] px-2 md:px-8 bg-zinc-900 bg-opacity-20 backdrop-blur-md backdrop-filter fixed z-[2000] ">
        ...
        <div className="grid gap-1 grid-flow-col ms-auto">
          <span 
          ...
          <span className="hidden md:inline-flex p-3 self-center invert hover:bg-[#f1f1f12b] hover:duration-900 rounded-full duration-200">
          ...
          {isAuth
            ...
            <Link 
            to={`/user`}
            className='p-2 hover:bg-[#f1f1f12b] invert hover:duration-900 rounded-full duration-200'            
            >
              <PiUserCircleLight className='cursor-pointer h-9 w-9 self-center text-zinc-900 hover:bg-[#dadada2b] hover:duration-900 rounded-full duration-200'/>
            </Link>
            :
            <span 
              className='p-2 hover:bg-[#f1f1f12b] invert hover:duration-900 rounded-full duration-200'
              onClick={handleLoginVisiblity}
